...
//  private final String allResult;
  ...
  public Summarizer(String inputText, Ranker ranker) {
      
      this.fileContentString = inputText;
  ...
  public ArrayList<String> fileSummarize() {
      ...
      return(sortAndWriteFile(P)); //sort and ouput the sorted sentences
  ...
  private ArrayList<String> sortAndWriteFile(double[] P) {
...
//          result += "(";
//              
//          result += df.format(keyWeight);
//              
//          result += ") ";
              
          String content = getSentenceString(valueIndex);
